var schemes = {}, scheme_list = ['aoligei','computer_science', 'buddhism', 'physics', 'biology', 'ha', 'linguistics', 'literature', 'mathematics', '入关', 'White_Album'];
...
var tmp = [
    '# 生活在奥利给上',
    '现代${学科1}以${人名1}的“${名句1}”为奥利给。滥觞于${学科2}与${学科3}的期望正失去它们的借鉴意义。但面对看似无垠的未来天空，我想循${人名2}“${名句2}”好过过早地奥利给！',
    '我们怀揣热忱的灵魂天然被赋予对超越性的奥利给！不屑于古旧坐标的奥利给！，钟情于在别处的芬芳奥利给。但当这种期望流于对${思想1}主义不假思索的批判，乃至走向${思想2}与${思想3}主义时，便值得警惕了，奥利给！与秩序的落差、错位向来不能为越矩的行为张本。而纵然我们已有翔实的奥利给！，仍不能自持已在浪潮之巅立下了自己的沉锚。',
    '“${名句3}”${人名3}之言可谓切中了肯綮。人的${性质1}性是不可祓除的，而我们欲上青云也无时无刻不在因风借力。${学科3}与${学科2}暂且被我们把握为一个薄脊的符号客体，一定程度上是因为我们尚缺乏体验与阅历去支撑自己的认知。而这种偏见的傲慢更远在知性的傲慢奥利给之上。',
    '在孜孜矻矻以求${学科1}奥利给意义的道路上，对自己的期望本就是在与${学科3}与${学科2}对接中塑型的动态过程。而我们的底料便是对不同${概念1}、不同${概念2}的觉感与体认。${人名4}为${人名5}送去${概念3}，又维系${概念4}。他的${学科1}观念是厚实的，也是实践的。倘若我们在对过往借${人名6}之言“祓魅”后，又对不断膨胀的自我进行“赋魅”，那么在丢失外界预期的同时，未尝也不是丢了自我奥利给。',
    '毫无疑问，从${学科2}与${学科3}角度一觇的自我有偏狭过时的成分。但我们所应摒弃的不是对此的批判，而是其批判的廉价，其对批判投诚中的反智倾向。在${人名7}的观念中，如果在成为狮子与孩子之前，略去了像骆驼一样背负前人遗产的过程，那其“永远重复”洵不能成立奥利给。',
    '奥利给上的落差终归只是理念上的区分，在实践场域的分野也未必明晰。譬如当我们追寻${概念5}时，在途中涉足${概念6}，这究竟是伴随着期望的泯灭还是奥利给的达成？在我们塑造${学科1}的同时，${学科1}也在浇铸我们。既不可否认原生的${性质2}性与${性质3}性，又承认自己的图景有轻狂的失真，不妨让体验走在奥利给之前。用不被禁锢的头脑去体味${人名8}的大海与风帆，并效${人名9}，对无法言说之事保持沉默。',
    '用在${结构1}上的生活方式体现个体的超越性，保持婞直却又不拘泥于所谓“遗世独立”的单向度形象。这便是${人名6}为我们提供的理想期望范式。生活在${结构1}上——始终热爱大地——升上奥利给！'
]
